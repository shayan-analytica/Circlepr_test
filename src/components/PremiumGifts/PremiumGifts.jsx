    ...
    <>
      <section className="container-fluid premium-gifts">
        <div className="row mb-5">
          <div className="col-12">
            <span className="pg">
              Premium Gifts.{" "}
              <span>
                Leveling Up Connections with Corporate Gifting Solutions.{" "}
              </span>
            </span>
          </div>
        </div>
        <div className="row cards-row swiper">
          ...
          <div
            className="col-md-12 cards-container p-2"
            id="giftslider"
            ref={giftslider}
          >
            <div
