   ...
   <footer id="footer">
        <div className="row mb-4">
            <div className="logo-container">
                <img src="src/assets/logos/CirclePR v5 white .png" alt="" style={{objectFit: 'contain'}} className="h-100 w-100" />

            </div>
        </div>
        <div className="row d-flex justify-content-between">
            <div className="d-flex align-items-baseline footer-links" style={{width: 'fit-content'}}>
                <div>
                ...
                <div>
                    <ul className="">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#giftingslider">Features</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#blogs">Blog</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#contact" style={{border: '0'}}>Contact</a>
                        </li>

                    </ul>
                </div>
            </div>
            <div className="d-flex align-items-center footer-social" style={{width: 'fit-content', gap: '24px'}}>
                <svg onClick={(event) => navigateTo(event)} data-url="https://www.instagram.com/circleprapp/"
                ...
                <svg onClick={(event) => navigateTo(event)} data-url="https://twitter.com/cicleprapp/"
                ...
                <svg onClick={(event) => navigateTo(event)} data-url="https://www.facebook.com/circleprapp//"
                ...
                <svg onClick={(event) => navigateTo(event)} data-url="https://www.tiktok.com/@circleprapp/"
