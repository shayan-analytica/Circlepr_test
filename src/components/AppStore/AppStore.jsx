      ...
      <section className="container-fluid app-store-banner d-flex flex-column justify-content-center align-items-center">
        ...
        <div className="row">
          <div className="col-12 d-flex justify-content-center">
            <p>
              Enjoy easy, personalized suggestions, and multiple available
              options wherever you are. Elevate your experience with our mobile
              app!{" "}
            </p>
          </div>
        </div>
        <div className="row">
          <div
            className="col-12 d-flex flex-row btn-container"
            style={{ gap: "16px" }}
          >
            <button
              data-aos="fade-right"
